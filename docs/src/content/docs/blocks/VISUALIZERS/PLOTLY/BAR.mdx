...
import app from "@blocks/VISUALIZERS/PLOTLY/BAR/app.json";
...
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/VISUALIZERS/PLOTLY/BAR/BAR.py)
...
<AppDisplay app={app} blockName="BAR" client:visible />
