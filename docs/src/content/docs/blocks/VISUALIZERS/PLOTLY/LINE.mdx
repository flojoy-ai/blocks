...
import app from "@blocks/VISUALIZERS/PLOTLY/LINE/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/VISUALIZERS/PLOTLY/LINE/LINE.py)
</details>
