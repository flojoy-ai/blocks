...
import app from "@blocks/VISUALIZERS/PLOTLY/HEATMAP/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/VISUALIZERS/PLOTLY/HEATMAP/HEATMAP.py)
</details>

## Example

<AppDisplay app={app} blockName="HEATMAP" client:visible />
