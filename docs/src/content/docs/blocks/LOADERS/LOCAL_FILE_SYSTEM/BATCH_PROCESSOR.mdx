...
import app from "@blocks/LOADERS/LOCAL_FILE_SYSTEM/BATCH_PROCESSOR/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/LOADERS/LOCAL_FILE_SYSTEM/BATCH_PROCESSOR/BATCH_PROCESSOR.py)
</details>
