...
import app from "@blocks/IO/PROTOCOLS/GPIB/PROLOGIX/PROLOGIX_MODE/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/IO/PROTOCOLS/GPIB/PROLOGIX/PROLOGIX_MODE/PROLOGIX_MODE.py)
</details>
