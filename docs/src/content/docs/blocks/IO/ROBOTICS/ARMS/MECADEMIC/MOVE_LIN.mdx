...
import app from "@blocks/IO/ROBOTICS/ARMS/MECADEMIC/MOVE_LIN/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/IO/ROBOTICS/ARMS/MECADEMIC/MOVE_LIN/MOVE_LIN.py)
</details>
