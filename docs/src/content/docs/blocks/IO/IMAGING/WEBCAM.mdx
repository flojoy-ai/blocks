...
import app from "@blocks/IO/IMAGING/WEBCAM/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/IO/IMAGING/WEBCAM/WEBCAM.py)
</details>
