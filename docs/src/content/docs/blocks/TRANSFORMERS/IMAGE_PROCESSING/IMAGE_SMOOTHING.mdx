...
import app from "@blocks/TRANSFORMERS/IMAGE_PROCESSING/IMAGE_SMOOTHING/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/TRANSFORMERS/IMAGE_PROCESSING/IMAGE_SMOOTHING/IMAGE_SMOOTHING.py)
</details>
