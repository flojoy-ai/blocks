...
import app from "@blocks/TRANSFORMERS/IMAGE_PROCESSING/EXTREMA_DETERMINATION/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/TRANSFORMERS/IMAGE_PROCESSING/EXTREMA_DETERMINATION/EXTREMA_DETERMINATION.py)
</details>
