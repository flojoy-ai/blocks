...
import app from "@blocks/TRANSFORMERS/IMAGE_PROCESSING/CHANNEL_SPLIT/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/TRANSFORMERS/IMAGE_PROCESSING/CHANNEL_SPLIT/CHANNEL_SPLIT.py)
</details>
