...
import app from "@blocks/NUMPY/LINALG/EIGH/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/NUMPY/LINALG/EIGH/EIGH.py)
</details>
