...
import app from "@blocks/NUMPY/LINALG/SVD/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/NUMPY/LINALG/SVD/SVD.py)
</details>
