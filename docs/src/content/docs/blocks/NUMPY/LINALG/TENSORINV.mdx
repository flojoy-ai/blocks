...
import app from "@blocks/NUMPY/LINALG/TENSORINV/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/NUMPY/LINALG/TENSORINV/TENSORINV.py)
</details>
