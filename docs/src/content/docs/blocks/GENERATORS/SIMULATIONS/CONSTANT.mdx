...
import app from "@blocks/GENERATORS/SIMULATIONS/CONSTANT/app.json";
...
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/GENERATORS/SIMULATIONS/CONSTANT/CONSTANT.py)
