...
import app from "@blocks/SCIPY/SIGNAL/DECIMATE/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/SCIPY/SIGNAL/DECIMATE/DECIMATE.py)
</details>
