...
import app from "@blocks/SCIPY/SIGNAL/WELCH/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/SCIPY/SIGNAL/WELCH/WELCH.py)
</details>
