...
import app from "@blocks/SCIPY/SIGNAL/ARGRELMAX/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/SCIPY/SIGNAL/ARGRELMAX/ARGRELMAX.py)
</details>
