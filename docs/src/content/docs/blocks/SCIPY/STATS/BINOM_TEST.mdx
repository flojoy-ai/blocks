...
import app from "@blocks/SCIPY/STATS/BINOM_TEST/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/SCIPY/STATS/BINOM_TEST/BINOM_TEST.py)
</details>
