...
import app from "@blocks/SCIPY/STATS/TRIM1/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/SCIPY/STATS/TRIM1/TRIM1.py)
</details>
