...
import app from "@blocks/SCIPY/STATS/DESCRIBE/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/SCIPY/STATS/DESCRIBE/DESCRIBE.py)
</details>
