...
import app from "@blocks/SCIPY/STATS/BAYES_MVS/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/SCIPY/STATS/BAYES_MVS/BAYES_MVS.py)
</details>
