...
import app from "@blocks/SCIPY/STATS/JARQUE_BERA/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/SCIPY/STATS/JARQUE_BERA/JARQUE_BERA.py)
</details>
