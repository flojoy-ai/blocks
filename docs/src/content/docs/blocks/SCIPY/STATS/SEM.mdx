...
import app from "@blocks/SCIPY/STATS/SEM/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/SCIPY/STATS/SEM/SEM.py)
</details>
