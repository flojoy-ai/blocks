...
import app from "@blocks/SCIPY/STATS/TMAX/app.json";
...
```
[Find this Flojoy Block on GitHub](https://github.com/flojoy-ai/blocks/blob/main/blocks/SCIPY/STATS/TMAX/TMAX.py)
</details>
