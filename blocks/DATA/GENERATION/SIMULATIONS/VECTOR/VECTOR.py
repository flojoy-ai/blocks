...
@flojoy
def VECTOR(elements : str = "", elements_type : Literal["boolean", "integer"] = "boolean") -> Vector:
    ...
    if elements_type == "boolean":
        ...
        raise ValueError(f"all elements of the vector must be in boolean or integer type: {all_bool}")
